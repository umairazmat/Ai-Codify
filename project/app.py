...
def main():
    ...
    # Instructions
    st.write("Upload a file or paste your code below to get an AI-generated code review.")
    
    # Input Methods: File Upload or Text Area
    uploaded_file = st.file_uploader("Upload a code file (Max 500 lines)", type=["py", "js", "txt"])
    ...
    if uploaded_file:
        ...
        if len(code.splitlines()) > 500:
            st.error("File is too large! Please upload a file with a maximum of 500 lines.")
